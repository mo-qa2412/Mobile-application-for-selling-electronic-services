...
class DeveloperCurrentOrdersPage extends StatefulWidget {
  const DeveloperCurrentOrdersPage({super.key});

  @override
  State<DeveloperCurrentOrdersPage> createState() =>
      _DeveloperCurrentOrdersPageState();
}

class _DeveloperCurrentOrdersPageState
    extends State<DeveloperCurrentOrdersPage> {
  late Future<List<ServiceOrder>> orders;
  @override
  void initState() {
    orders = ServiceDBHelper.getDeveloperServiceOrders();
    super.initState();
  }
